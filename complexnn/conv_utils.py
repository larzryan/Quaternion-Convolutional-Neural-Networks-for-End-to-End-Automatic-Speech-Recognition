...
# LTR: Copied from https://github.com/keras-team/tf-keras/blob/v2.19.0/tf_keras/utils/conv_utils.py
#      to satisfy requirement of complexnn library call of Keras utilities.
